        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-4 pt-0 pb-2">
                <form action="{{ route('competency.elements.add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="competency_standards_id" value="{{ $competency_standards_id }}">
                    <div class="form-group">
                        <label for="criteria" class="form-control-label">Criteria</label>
                        <input class="form-control @error('criteria') is-invalid @enderror" type="text" value="{{ old('criteria') }}" id="criteria" name="criteria">
                        @error('criteria')
