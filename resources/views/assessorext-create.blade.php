    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#ass" data-bs-toggle="collapse" aria-expanded="false" aria-controls="ass">
          ...
          <span class="nav-link-text ms-1 active">Assessor</span>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Create Assessor External</h6>
            </div>
            <div class="card-body px-4 pt-0 pb-2">
                <form action="{{ route('assessor.create', ['type' => 'External']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
