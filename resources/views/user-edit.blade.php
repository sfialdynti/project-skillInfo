            ...
            <div class="card-body px-4 pt-0 pb-2">
              <form action="/user/update/{{ $user->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('full_name') is-invalid @enderror" type="text" value="{{ old('full_name', $user->full_name ?? '') }}" id="full_name" name="full_name">
                    @error('full_name')
                ...
                <div class="form-group">
                  ...
                  <input class="form-control @error('username') is-invalid @enderror" type="text" value="{{ old('username', $user->username ?? '') }}" id="username" name="username">
                  @error('username')
                    <div class=" invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control @error('email') is-invalid @enderror" type="email" value="{{ old('email', $user->email ?? '') }}" id="email" name="email">
                  @error('email')
                    <div class=" invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control @error('password') is-invalid @enderror" type="password" value="{{ old('password', $user->password ?? '') }}" id="password" name="password">
                  @error('password')
                    <div class=" invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control @error('phone_number') is-invalid @enderror" type="tel" value="{{ old('phone_number', $user->phone_number ?? '') }}" id="phone_number" name="phone_number">
                  @error('phone_number')
                    <div class=" invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    @if ($user->image)
                        <div>
                          <img src="{{ asset('storage/image/'.$user->image) }}" alt="" width="100px" style="border-radius: 10px">
                        </div>
                    @endif
