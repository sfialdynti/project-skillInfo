            ...
            <div class="card-body px-4 pt-0 pb-2">
                <form action="/student/update/{{ $student->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('nisn') is-invalid @enderror" type="text" value="{{ old('nisn', $student->nisn ?? '') }}" id="nisn" name="nisn">
                        @error('nisn')
                    ...
                    <div class="form-group">
                        ...
                        <select name="grade_level" id="grade_level" class="form-control">
                            <option value="10" {{ old('grade_level', $student->grade_level) == 10 ? 'selected' : '' }}>Grade 10</option>
                    ...
                    <div class="form-group">
                      ...
                      @foreach ($major as $item)
                          <option value="{{ $item->id }}" {{ $item->id == $student->majors_id ? 'selected' : ''  }}>{{ $item->major_name }}</option>
                      @endforeach
                      </select>
                      @error('majors_id')
                        <div class=" invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($user as $item)
                            <option value="{{ $item->id }}" {{ $item->id == $student->users_id ? 'selected' : '' }}>{{ $item->full_name }}</option>
                        @endforeach
                        </select>
                        @error('users_id')
                          <div class=" invalid-feedback">{{ $message }}</div>
